  ...
  args: {
    ...
    children: (
      <div className="relative z-10">
        <h3 className="font-normal mb-2">Panel Component</h3>
  ...
  render: () => (
    <div className="flex flex-col gap-6 w-[600px]">
      <Panel radius="default" padding="lg">
        <p className="text-base font-normal mb-1">Default (rounded-2xl)</p>
        <p className="text-sm text-white/60">Standard border radius</p>
      </Panel>
      <Panel radius="lg" padding="lg">
        <p className="text-base font-normal mb-1">Large (rounded-3xl)</p>
        <p className="text-sm text-white/60">Larger border radius</p>
      </Panel>
      <Panel radius="xl" padding="lg">
        <p className="text-base font-normal mb-1">XL (rounded-[2rem])</p>
