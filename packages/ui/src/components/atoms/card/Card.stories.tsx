...
export const Interactive: Story = {
  ...
  render: (args) => (
    <div className="max-w-md">
      <Card {...args}>
        <h3 className="text-lg font-normal mb-2">Card Title</h3>
      ...
      <div>
        ...
        <div className="flex flex-wrap gap-6">
          <Card variant="highlight" className="max-w-xs">
            <div className="p-6">
              <h3 className="text-lg font-normal mb-2">Highlight</h3>
          ...
          <Card variant="glass" className="max-w-xs">
            <div className="p-6">
              <h3 className="text-lg font-normal mb-2">Glass</h3>
              <p className="text-muted-foreground text-sm">
          ...
          <Card variant="solid" className="max-w-xs">
            <div className="p-6">
              <h3 className="text-lg font-normal mb-2">Solid</h3>
              <p className="text-muted-foreground text-sm">
      ...
      <div className="border-t border-border pt-4">
        ...
        <div className="flex flex-wrap gap-6">
          <Card variant="highlight" padding="sm">
            <h3 className="text-lg font-normal mb-2">Small</h3>
            <p className="text-muted-foreground text-sm">p-4 (16px)</p>
          </Card>
          <Card variant="highlight" padding="md">
            <h3 className="text-lg font-normal mb-2">Medium</h3>
            <p className="text-muted-foreground text-sm">p-6 (24px)</p>
          </Card>
          <Card variant="highlight" padding="lg">
            <h3 className="text-lg font-normal mb-2">Large</h3>
