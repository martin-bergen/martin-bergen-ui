    ...
    (
        ...
        return (
            <Card
                ...
                variant="highlight"
                className={cn(
                    "w-full min-w-[280px] max-w-[413px] py-[var(--spacing-feature-card-padding-vertical)] px-[var(--spacing-feature-card-padding-horizontal)] transition-all duration-300 hover:scale-105",
                    className
                )}
                {...props}
            >
