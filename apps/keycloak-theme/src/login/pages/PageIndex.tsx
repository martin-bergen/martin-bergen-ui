...
const Page_webauthn_authenticate = lazy(
  () => import("./webauthn-authenticate"),
);
const Page_webauthn_register = lazy(() => import("./webauthn-register"));
const Page_login_update_password = lazy(
  () => import("./login-update-password"),
);
const Page_link_idp_action = lazy(() => import("./link-idp-action"));
const Page_login_update_profile = lazy(() => import("./login-update-profile"));
const Page_login_idp_link_confirm = lazy(
  () => import("./login-idp-link-confirm"),
);
...
const Page_idp_review_user_profile = lazy(
  () => import("./idp-review-user-profile"),
);
...
const Page_delete_account_confirm = lazy(
  () => import("./delete-account-confirm"),
);
...
const Page_login_recovery_authn_code_input = lazy(
  () => import("./login-recovery-authn-code-input"),
);
...
const Page_login_idp_link_confirm_override = lazy(
  () => import("./login-idp-link-confirm-override"),
);
const Page_select_organization = lazy(() => import("./select-organization"));
// Phase Two magic link pages
const Page_otp_form = lazy(() => import("./otp-form"));
const Page_view_email = lazy(() => import("./view-email"));
const Page_email_confirmation = lazy(() => import("./email-confirmation"));
